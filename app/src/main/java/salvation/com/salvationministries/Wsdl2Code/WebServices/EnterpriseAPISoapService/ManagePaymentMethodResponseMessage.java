...
public class ManagePaymentMethodResponseMessage implements KvmSerializable {

    public VectorcustomField customFields;
    public String displayMessage;
    public VectorManagePaymentMethodResponseMessageEntry managePaymentMethodData;
    ...
    public ManagePaymentMethodResponseMessage() {
    }

    public ManagePaymentMethodResponseMessage(SoapObject soapObject) {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("managePaymentMethodData")) {
            SoapObject j = (SoapObject) soapObject.getProperty("managePaymentMethodData");
            managePaymentMethodData = new VectorManagePaymentMethodResponseMessageEntry(j);
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch (index) {
            ...
            case 2:
                info.type = PropertyInfo.VECTOR_CLASS;
                info.name = "managePaymentMethodData";
                break;
            case 3:
                info.type = PropertyInfo.STRING_CLASS;
