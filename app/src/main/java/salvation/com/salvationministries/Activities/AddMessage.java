...
public class AddMessage extends AppCompatActivity {
    ...
    private String messagePriceDollar = "";
    private String messagePriceNaira = "";
    private String messagePoint = "";
    private String downloadUrl = "";
    private Uri messageUri;
    private Uri coverImageUri;
    private EditText edtTitle,edtPriceDollar,edtPriceNaira,edtMessagePoint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtMessagePoint = findViewById(R.id.edtMessagePoint);
    ...
    private void startUploadingMessage() {
        ...
        messagePoint = edtMessagePoint.getText().toString().trim();

        if (messageUri != null ||coverImageUri != null || !messagetitle.isEmpty()||!messagePriceNaira.isEmpty()||!messagePriceDollar.isEmpty()||!messageExtension.isEmpty()|| !messageGenre.isEmpty()||!messageType.isEmpty()||!messagePoint.isEmpty()){
                            ...
                            mUploadTask = fileReference.putFile(coverImageUri)
                                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        imageUrl= taskSnapshot.getDownloadUrl().toString();
                                            ...
                                            messageModel.setAuthor(author);
                                            messageModel.setKey(key);
                                            messageModel.setPoints(Integer.parseInt(messagePoint));
